...
echo "Starting codezilla copilot update process..."
...
LATEST_RELEASE_URL=$(curl -s https://github.com/foxban99/codezilla-copilet-v0.2.git/latest | grep "browser_download_url.*zip" | cut -d : -f 2,3 | tr -d \")
